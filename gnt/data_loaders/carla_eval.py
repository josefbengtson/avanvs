...
class CarlaEvalDataset(Dataset):
    def __init__(self, args, mode, scenes=(), random_crop=True, **kwargs):
        self.folder_path = os.path.join(args.rootdir, "data/carla_render/")
        self.args = args
        ...
        if conditions_text == "Default":
            ...
            # conditions = np.random.choice(conditions_all, size=2, replace=False)
            ...
            return
        # print("len cond:", len(conditions_text))
        print("conditions to Load: ", conditions_load)
        print("num conditions: ", len(conditions_load))
        ...
        if self.appearance_change or self.num_conditions == 0:
            for i, scene in enumerate(scenes):
                ...
                scene_conditions = conditions_load
    ...
    def __getitem__(self, idx):
        num_conditions = self.conditions.shape[0]
        ...
        # print("lenght: ", len(nearest_pose_ids))
        ...
        if self.num_conditions > 1 and self.appearance_change:
            ...
            return {
                ...
                "scene": self.scene_names[train_set_id]
            }
        else:
            return {
                "rgb": torch.from_numpy(rgb[..., :3]),
